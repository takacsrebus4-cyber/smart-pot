...
char pass[] = "TakacsPereta136";        // your network password (use for WPA, or use as key for WEP)
...
/* -------------------------------------------------------------------------- */
  ...
  if (client.connect(server, 443)) {
    ...
    //client.println("POST /query/plants HTTP/1.1");
    //client.println("Body: ");
    //client.println("Host: smartpot.taki02.org");
    //client.println("Connection: close");
    //client.println();
  }
  else{
